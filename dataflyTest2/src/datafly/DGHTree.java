...
public class DGHTree 
{
    ...
    public DGHTree createDGHTree(ArrayList<String> values) throws FileNotFoundException{
        ...
        //ArrayList<ArrayList> valueNodeParents = new ArrayList<>();
            ...
            String dghFile = "C:\\Users\\Hu DongCheng\\eclipse-workspace\\dataFlyTest2\\src\\datafly\\dghNumericData.txt";
    ...
    public DGHTree createDGHTreeForDate(ArrayList<String> dates) throws FileNotFoundException{
        ...
        ArrayList<DGHNode> dateNodes = new ArrayList<>();
           ...
           for(int i = 0; i < dates.size(); i++){
            ...
            String dghFile = "/Users/Hu DongCheng/eclipse-workspace/dataFlyTest2/src/datafly/AdultTest.txt";
            File infile = new File(dghFile);
            PrintWriter writer = new PrintWriter(infile); 
    ...
    */
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<String> values =new ArrayList<>(Arrays.asList("1","2","3","5","8","13","21"));
        tree2 = tree2.createDGHTree(values);
        ...
        DGHTree tree3 = new DGHTree("/Users/Hu DongCheng/eclipse-workspace/dataFlyTest2/src/datafly/" + "dghSex");
        //DGHTree tree4 = new DGHTree("/Users/Hu DongCheng/eclipse-workspace/dataFlyTest/src/datafly/" + "dghRace");
        /*ArrayList<String> testValues = new ArrayList<>(Arrays.asList("77516,215646,234721,45781,159449"));
        DGHTree treeTest= */
        tree2.setHeight();
        tree3.setHeight();
        //tree4.setHeight();
